        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Complete Belting Solutions for Industrial Applications
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>Plastic Modular Belts</li>
              <li>Heavy Duty Belts</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400 text-sm">
              <div className="flex items-start space-x-2">
                ...
                <span>Mangal Bakery Machines, Goaves Circle, Opp. Khau Katta, BELAGAVI - 590001</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone size={18} />
                <span>9743533859, 9916419000</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail size={18} />
